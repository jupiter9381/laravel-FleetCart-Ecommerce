...
class ProductTabs extends Tabs
{
    ...
    private function general()
    {
        return tap(new Tab('general', trans('product::products.tabs.general')), function (Tab $tab) {
            $tab->active();
            $tab->weight(5);
            $tab->fields(['name', 'description', 'is_active', 'is_downloadable']);
    ...
    public function file(){
        // /var_dump(trans('product::products.tabs.file')));
        return tap(new Tab('file', trans('product::products.tabs.file')), function (Tab $tab) {
            

            $tab->view('product::admin.products.tabs.file');
        });
    }
