<div class="row">
    <div class="col-md-8">
        ...
        {{ Form::checkbox('paypal_express_test_mode', trans('setting::attributes.paypal_express_test_mode'), trans('setting::settings.form.use_sandbox_for_test_payments'), $errors, $settings) }}
